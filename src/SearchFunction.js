...
var SearchFunction = /** @class */ (function () {
    ...
    SearchFunction.prototype.main = function () {
        return __awaiter(this, void 0, void 0, function () {
            var i, j;
            return __generator(this, function (_a) {
                for (i = 0; i < this.miniProducts.length; i++) {
                    for (j = 0; i < this.miniProducts[i].length; i++) {
